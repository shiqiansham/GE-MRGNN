...
选项:
    --help              显示此帮助信息
    --run_demo          运行单个模型演示
    --run_comparison    运行对比实验 (GCN vs GAT vs RGCN vs GE-MRGNN)
    --model MODEL       指定模型类型: gcn, gat, rgcn, rgcn_group (默认: rgcn_group)
...
示例:
    ...
    # 训练 GCN 基线模型
    python main.py --run_demo --model gcn --epochs 50
